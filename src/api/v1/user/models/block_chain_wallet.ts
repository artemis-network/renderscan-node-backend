...
export interface BlockChainWalletDoc
  extends BlockChainWalletInterface,
    Document {}
...
export class BlockChainWallet {
  ...
  constructor(wallet: BlockChainWalletInterface) {
    this.wallet = wallet;
  }
...
export const BlockChainWalletModel: Model<BlockChainWalletDoc> =
  mongoose.model<BlockChainWalletDoc>(
    BLOCK_CHAIN_WALLET_NAMING,
