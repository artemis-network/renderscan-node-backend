...
export enum ImageType {
	MINTED, SCANNED, GENERATED, IMPORTED
}
...
const NFTSchema = new Schema({
	...
	type: {
		type: Schema.Types.String, enum: [
			ImageType.MINTED, ImageType.SCANNED,
			ImageType.IMPORTED, ImageType.GENERATED,],
		required: true
	}
});
...
export class NFT {
	nft: NFTInterface;
	constructor(nft: NFTInterface) { this.nft = nft }
...
export const NFTModel: Model<NFTDoc> = mongoose.model<NFTDoc>(NFT_NAMING, NFTSchema);